...
public class TreeSpeed {
	...
	private static void timePolymorphicTree(){
		...
		System.out.println("Random PolymorphicBST Time(msec) = "+time);
		...
		time = System.currentTimeMillis() - time;
		System.out.println("Sequential PolymorphicBST Time(msec) = "+time);
	}
	...
	private static void timeTreeMap(){
		...
		time = System.currentTimeMillis() - time;
		System.out.println("Random TreeMap Time(msec) = "+time);
		...
		time = System.currentTimeMillis() - time;
		System.out.println("Sequential TreeMap Time(msec) = "+time);
	}
}
