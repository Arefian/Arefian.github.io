...
public class SupportPublicTests {
	...
	public static String pubTest3Deal() {
		...
		blackjack.deal();
		//blackjack.getDealerCardsEvaluation();
		System.out.println(blackjack.getDealerCardsEvaluation());
		System.out.println(blackjack.getDealerCardsTotal());
		System.out.println(blackjack.getPlayerCardsTotal());
