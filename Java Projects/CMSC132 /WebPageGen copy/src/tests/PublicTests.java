...
public class PublicTests {
	...
	public void pubHeadingElementTestA() {
		...
		TagElement.resetIds();
		TagElement.enableId(false);
		TextElement y = new TextElement("Introduction");
		HeadingElement element = new HeadingElement(y, level, attributes);
		answer = element.genHTML(indentation);
		//System.out.println(answer);
	...
	//	TableElement tableElement2 = 
		...
		tableElement.addItem(0, 0, new TableElement(2, 2, null));
